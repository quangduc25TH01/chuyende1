          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <ProductOutlined size={30} className="text-[20px]" />
                  Sản phẩm
                </NavLink>
              </li>
              ...
              <li>
                ...
                >
                  <MdOutlineShoppingCartCheckout size={19} />
                  Đơn hàng
                </NavLink>
              </li>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/manager' || pathname.includes('manager')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <VscOpenPreview size={20} className="text-[20px]" />
                        Quản lý
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                            open && 'rotate-180'
